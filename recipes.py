...
import os
clientId = os.environ.get('TID')
clientSecret = os.environ.get('TPWD')
HTTP_PROXY="http://{0}:{1}@sogramihqprxy01.info53.com:8080/".format(clientId,clientSecret)
HTTPS_PROXY="https://{0}:{1}@sogramihqprxy01.info53.com:8080/".format(clientId,clientSecret)
